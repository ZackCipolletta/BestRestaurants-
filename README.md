...
1. Clone this repo.
2. Open the terminal and navigate to this project's production directory called "RestaurantCuisine".
3. Within the production directory "RestaurantCuisine", create a new file called `appsettings.json`.
...
5. Within the production directory "RestaurantCuisine", run `dotnet watch run` in the command line to start the project in development mode with a watcher.
...
- https://www.learnhowtoprogram.com/c-and-net/database-basics/showing-restaurant-details-with-ef-core
